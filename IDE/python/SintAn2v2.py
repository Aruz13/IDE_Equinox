...
class Parser:
    ...
    def match(self, token_type):
        if self.current_token and self.current_token.token_type == token_type:
            ...
            sync_tokens = {"main", "{", "}", "int", "float", "if", "while", "do", "cin", "cout", "end", ";", "(", ")"}
            while self.current_token and self.current_token.token_type not in sync_tokens:
                print("Saltado: ",self.current_token.token_type," - ",self.current_token)
                self.advance()
            
            if self.current_token:
                print("Encontrado Sync: ",self.current_token.token_type," - ",self.current_token)
                self.advance()
